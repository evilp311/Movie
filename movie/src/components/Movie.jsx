...
export default function Movie ({movie}){
    ...
    <>
        ...
        <div className="flex gap-[80px] px-[380px] py-[80px] ">
            <div className="">
                <img src={poster} alt="" className="rounded-3xl min-w-[480px] h-[720px]" />
            </div>
            <div className="mt-[80px]" >
                <p className="text-[#8E95A9] mt-[24px]">{plot}</p>
                <p className="mt-[24px] text-[#FFAD49] py-1 px-2   rounded-[8px] bg-[#000000A6] inline-flex items-center gap-1 "><Star/> <span>{rating}</span> </p>
